...
class HeroesController {
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const heroes = yield database_1.default.query('SELECT * FROM heroes WHERE id =?', [id]);
            if (heroes.length > 0) {
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('DELETE FROM heroes WHERE id = ?', [id]);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('UPDATE heroes set ? WHERE id=?', [req.body, id]);
