    ...
    loginUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (user.length > 0) {
                ...
                const uuser = yield database_1.default.query("SELECT id_user, sub, name, picture, email, roles.id_role, roles.role_user, enterprise.id_enterprise,enterprise.name_enterprise, contacto FROM user inner JOIN roles on roles.id_role = user.role inner JOIN enterprise on enterprise.id_enterprise = user.id_empresa WHERE sub = ?", [id]);
